...
// ===== 证照相关 =====
// 第二套 emoji 方案：更直观的证照图标

const COLOR_MAP = {
  '🪪': '#6366F1', '📘': '#10B981', '🚗': '#F59E0B', '🎓': '#8B9CF7',
  '💳': '#EF4444', '📄': '#F59E0B', '🏥': '#10B981', '🛡️': '#1E293B',
  '🏠': '#EA580C', '✈️': '#14B8A6', '⚓': '#2563EB', '🚨': '#DC2626',
  '📑': '#8B5CF6', '🧾': '#64748B', '🪪': '#6366F1', '📋': '#8e8e93',
};
...
const DEFAULT_CATEGORIES = [
  { id: 'work',     name: '工作',   color: '#EF4444', icon: '📌' },
...
const COLOR_PALETTE = [
  ...
  '#78716C', '#64748B', '#475569', '#334155', '#1E293B',
];
